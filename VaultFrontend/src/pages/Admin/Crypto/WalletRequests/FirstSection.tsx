...
const FirstSection = () => {
  ...
  const walletRequestData = [
    { date: '2025-04-15', username: 'Shristy', email: 'A@example.com', coin:'BTC',  status: 'Success' },
    { date: '2025-04-11', username: 'Shristy', email: 'A@example.com', coin:'USDT', status: 'Success' },
    { date: '2025-04-11', username: 'Shristy', email: 'A@example.com', coin:'BTC', status: 'Success' },
    { date: '2025-04-08', username: 'Shristy', email: 'A@example.com', coin:'SOL', status: 'Pending' },
    { date: '2025-04-08', username: 'Shristy', email: 'A@example.com', coin:'SHIB', status: 'Success' },
    { date: '2025-04-08', username: 'Shristy', email: 'A@example.com', coin:'ADA', status: 'Success' },
  ];
  ...
  return (
    <Box>
      ...
      <GenericTable columns={columns} data={walletRequestData} />
