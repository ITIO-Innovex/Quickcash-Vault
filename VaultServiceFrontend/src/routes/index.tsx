...
import path from 'path';
  const PrivateRoute = ({ children }: { children: JSX.Element }) => {
    ...
    if (isAuthenticated === null) return null; // Or show a spinner temporarily
...
const router = createBrowserRouter([
  {
    element: <GuestPrivateRoute><RootLayout /></GuestPrivateRoute>,
    children: guestRoutes,
  },

  {
    element: <PrivateRoute><MinimalLayout /></PrivateRoute>,
    children: authRoutes,
  },
  {
    element: <AdminLayout />,
